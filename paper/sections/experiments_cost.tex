...
We add specialist and router costs per input, plus VLM cost at the actual call rate. Confidence omits router overhead. Component runtimes were measured on a single NVIDIA A800 GPU. These measurements estimate serial cost rather than integrated latency.
